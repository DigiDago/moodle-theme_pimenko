...
if ($ADMIN->fulltree) {
    ...
    $settings =
        new theme_boost_admin_settingspage_tabs(
            'themesettingpimenko',
            get_string(
                'configtitle',
                'theme_pimenko',
    ...
    $title = get_string(
        'brandcolortextbutton',
        'theme_pimenko',
    );
    $description = get_string(
        'brandcolortextbuttondesc',
        'theme_pimenko',
    );
    $setting = new admin_setting_configcolourpicker(
        $name,
    ...
    $name = 'theme_pimenko/enablegooglefont';
    $title = get_string(
        'enablegooglefont',
        'theme_pimenko',
    );
    $description = get_string(
        'enablegooglefont_desc',
        'theme_pimenko',
    );
    ...
    $setting = new admin_setting_configtext(
        'theme_pimenko/unaddableblocks',
        get_string(
            'unaddableblocks',
            'theme_pimenko',
        ),
        get_string(
            'unaddableblocks_desc',
            'theme_pimenko',
        ),
        $default,
        PARAM_TEXT,
