...
$page->add(
    new admin_setting_heading(
        'optionloginhtmlcontent',
        get_string(
            'optionloginhtmlcontent',
            'theme_pimenko',
        ),
        get_string(
            'optionloginhtmlcontentdesc',
            'theme_pimenko',
        ),
    ),
);
...
$default = '';
$setting = new theme_pimenko_admin_setting_confightmleditor(
    $name,
    $title,
    $description,
    $default,
...
$description = get_string(
    'rightblockloginhtmlcontentdesc',
    'theme_pimenko',
);
$setting = new theme_pimenko_admin_setting_confightmleditor(
    $name,
