 ...
 * @covers \theme_pimenko\external\save_cover_file
 */
final class external_save_cover_file_test extends \advanced_testcase {
    /**
    ...
    /**
     * Tests the functionality of saving and deleting cover files for a course.
     *
     * This method verifies:
     * - Upload of a cover file.
     * - Presence and properties of the file in storage.
     * - File deletion and cleanup of the corresponding area.
     *
     * @return void
     */
    public function test_save_cover_file(): void {
        $this->setAdminUser();
