 ...
 * @covers \theme_pimenko\external\search_courses
 */
final class external_search_courses_test extends \advanced_testcase {
    /**
    ...
    /**
     * Tests the functionality of searching courses using various criteria such as
     * course name, category, and category name, including validation for formatted summaries,
     * pagination support, and handling of no-result scenarios.
     *
     * @return void
     */
    public function test_search_courses(): void {
        ...
        $this->assertEquals(
            FORMAT_HTML,
            $result['courses'][0]['summaryformat'],
        );
    ...
    /**
     * Test the search functionality for courses within a category and its subcategories.
     *
     * This method verifies that the search behavior correctly identifies both parent
     * and child category courses when searching from a parent category, and only child
     * category courses when searching from a child category.
     *
     * @return void
     */
    public function test_search_courses_with_subcategories(): void {
        global $USER;
        ...
        $this->assertEquals(
            2,
            $result['total'],
            'Should find courses in both parent and child categories',
        );
    ...
    /**
     * Test the search_courses execution with subcategories when the search string is empty.
     *
     * Validates that an empty search string returns all courses belonging to the specified parent category,
     * including the ones in its subcategories.
     *
     * @return void
     */
    public function test_search_courses_with_subcategories_empty_search(): void {
        global $USER;
